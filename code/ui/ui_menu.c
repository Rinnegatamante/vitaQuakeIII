...
static void Main_MenuDraw( void ) {
	...
	if (uis.demoversion) {
		...
		UI_DrawString( 320, 430, "Thanks to The Vita3K Project, Tain Sueiras and RaveHeart for their support on Patreon", UI_CENTER|UI_SMALLFONT, color );
	} else {
		UI_DrawString( 320, 420, "Thanks to The Vita3K Project, Tain Sueiras and RaveHeart for their support on Patreon", UI_CENTER|UI_SMALLFONT, color );
