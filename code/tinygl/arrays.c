...
void
pglEnableClientState(GLenum array) {
    GLParam p[2];
...
void
pglDisableClientState(GLenum array) {
    GLParam p[2];
...
void
pglVertexPointer(GLint size, GLenum type, GLsizei stride,
...
void
pglColorPointer(GLint size, GLenum type, GLsizei stride,
               const GLvoid *pointer) {
    GLParam p[4];
    assert(type == GL_FLOAT);
...
void
pglNormalPointer(GLenum type, GLsizei stride,
                const GLvoid *pointer) {
    GLParam p[3];
    assert(type == GL_FLOAT);
...
void
pglTexCoordPointer(GLint size, GLenum type, GLsizei stride,
                  const GLvoid *pointer) {
    GLParam p[4];
    assert(type == GL_FLOAT);
